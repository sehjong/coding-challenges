...
// P: an array of integers, 0 if distance travelled between two consecutive floors are the same
...
// R: an integer representing the total distance travelled for visiting each floor in the array in order
// E: elevatorDistance([5,2,8]) = 9
//    elevatorDistance([1,2,3]) = 2
//    elevatorDistance([7,1,7,1]) = 18
//    elevatorDistance([3,3]) = 0
// P:
